...
// =============================================================================
   ...
   *  @param {[Object]} param    An object to be passed to the as the
   ...
   *  </code></div>
   */
  p5.MediaElement.prototype.setTimeline = function(callback, time, params) {
    var id = this._timelineEventIDCounter++;

    var timeline = new TimelineEvent(callback, time, id, params);
  ...
  p5.MediaElement.prototype._onTimeUpdate = function() {
    ...
    for (var i = 0 ; i < this._timelineEvents.length; i++) {
      ...
      var params = this._timelineEvents[i].params;


      if (this._prevTime < callbackTime && callbackTime <= playbackTime) {

        // pass the scheduled callbackTime as parameter to the callback
        this._timelineEvents[i].callback(callbackTime, params);
      }
  ...
  var TimelineEvent = function(callback, time, id, params) {
